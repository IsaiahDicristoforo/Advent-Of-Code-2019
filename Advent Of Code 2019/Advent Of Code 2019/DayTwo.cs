...
namespace Advent_Of_Code_2019
{
    class DayTwo
    {
        public static int SolveDayTwoPartOne()
        {
            ...
            {
                int opcodeInput1 = input[input[opcodeStartIndex + 1]];
                int opcodeInput2 = input[input[opcodeStartIndex + 2]];
                input[input[opcodeStartIndex + 3]] = input[opcodeStartIndex] == 1 ? 
                    opcodeInput1 + opcodeInput2 : opcodeInput1 * opcodeInput2;
                opcodeStartIndex += 4;
            }
            return input.First();
        }
